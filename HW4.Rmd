...
X(t) − 0.8474X(t-1) − 0.7465X(t−2) + 0.8091X(t−3) + 0.1250X(t−4) + 0.7143X(t−5) + 0.3948X(t−6) = Z(t) - 0.4225Z(t−1) + 1.1811Z(t−2) + 0.3485Z(t−3) − 0.4802Z(t−4) + 0.4261Z(t−5) − 0.2908Z(t−6)

for daily data, the coefficents are:
X(t) + 0.3565X(t-1) − 0.5897X(t−2) + 0.1171X(t−3) + 0.8214X(t−4) - 0.0698X(t−5) - 0.7964X(t−6) = Z(t) - 0.6431(t−1) + 0.246Z(t−2) + 0.3485Z(t−3) − 0.9491Z(t−4) - 0.2790Z(t−5) − 0.5356Z(t−6)
