...
acf(daily.return, main="ACF of daily return", na.action = na.pass, max.lag=400)

```
*Response: Return series vs price series analysis* 

Both plots of daily return and weekly return stock price have exhibit a non constant variance, this violates stationary that variance needs to be constant. From the ACF of weekly return, most of lags are out of confidence band, implies autocorrelation, a serial dependence, whereas the daily return acf plot, all lags are within confidence band,indicating a uncorrelated relation. 
