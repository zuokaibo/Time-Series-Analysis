...
```{r}
#### since total sales is given by here seasonally adjusted annual rates, I must translate/calculate them to the same measure that match the units of new orders
# ggregate(Total.Sales ~ DATE, data2, mean)
...
```{r}
### since the value of Total sales is seasonally adjusted annual rate, I need to translate the value of new orders to seasonally adjusted annual rate too 
