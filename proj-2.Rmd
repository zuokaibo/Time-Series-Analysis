...
new.sales.rate.plot = autoplot(new.sales.rate) + xlab("Date") + ylab("SAAR of Total Sales") + ggtitle("Total Sales - Seasonally Adjusted Annual Rate") 
new.sales.rate.plot

new.orders.rate.plot = autoplot(new.orders.rate) + xlab("Date") + ylab("SAAR of New Orders") + ggtitle("New Orders - Seasonally Adjusted Annual Rate")
...
From ACFs, I think it is now white noise since most lags are within 95% confidence band, some of the lags are outside the confidence band, due to the rest 5%.
