...
*Response*
indicator of DC state has an increasing trend in general. it also has a dramatic change on volatility, huge ups and downs. from the residual plots, it roughly follows normal distribution, but on both side of qq plot, it diverges a little bit. 
